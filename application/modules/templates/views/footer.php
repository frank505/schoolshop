				...
				<div class="row">
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">	
									<div class="item-slick3 image-partial-detail" data-thumb="">
										<div class="wrap-pic-w pos-relative">
											<img class="image-partial-detail"src="" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 image-partial-detail how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 class="mtext-105 cl2 js-name-detail p-b-14 product-header">
								
							</h4>

							<span class="mtext-106 cl2 price-product">


															</span>

							<p class="stext-102 cl3 p-t-23 description-product">
							...
							<div class="p-t-33">
								...
								<div class="flex-w flex-r-m p-b-10">
									<div class="size-204 flex-w flex-m respon6-next">
										<a  class="buy_area" href=""><button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
											Buy
										</button></a>
									</div>
								</div>	
